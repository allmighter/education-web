    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="批改状况" prop="pigaizhuangkuang">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.pigaizhuangkuang" label="批改状况" prop="pigaizhuangkuang">
                    <span v-html="ruleForm.pigaizhuangkuang"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.pigaizhuangkuang = this.ruleForm.pigaizhuangkuang.replace(reg,'../../../ssm9rv33/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
