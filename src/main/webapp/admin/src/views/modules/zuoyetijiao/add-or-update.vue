<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="作业链接" prop="zuoyelianjie">
          <el-input v-model="ruleForm.zuoyelianjie" 
              placeholder="作业链接" clearable  :readonly="ro.zuoyelianjie"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="作业链接" prop="zuoyelianjie">
              <el-input v-model="ruleForm.zuoyelianjie" 
                placeholder="作业链接" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
  ...
  data() {
	...
	xingming : false,
      ...
      rules: {
          ...
          zuoyelianjie: [
                { required: true, message: '作业链接不能为空', trigger: 'blur' },
